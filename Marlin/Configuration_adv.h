...
//#define HOMING_BACKOFF_POST_MM { 0, 2, 2 }  // (linear=mm, rotational=°) Backoff from endstops after homing
...
// LCD Print Progress options, multiple can be rotated depending on screen layout
  ...
  #define SD_ABORT_ON_ENDSTOP_HIT
    ...
    #define SD_ABORT_ON_ENDSTOP_HIT_GCODE "G28" // G-code to run on endstop hit (e.g., "G28XY" or "G27")
  #endif
